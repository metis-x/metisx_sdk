...
case $interrupt_selection in
	"0")
		...
		ret=`insmod ../xdma_driver/xdma.ko interrupt_mode=0`
		;;
	"1")
		echo "insmod xdma.ko interrupt_mode=1 ..."
		ret=`insmod ../xdma_driver/xdma.ko interrupt_mode=1`
		;;
	"2")
		echo "insmod xdma.ko interrupt_mode=2 ..."
		ret=`insmod ../xdma_driver/xdma.ko interrupt_mode=2`
		;;
	"3")
		echo "insmod xdma.ko interrupt_mode=3 ..."
		ret=`insmod ../xdma_driver/xdma.ko interrupt_mode=3`
		;;
	"4")
		echo "insmod xdma.ko poll_mode=1 ..."
		ret=`insmod ../xdma_driver/xdma.ko poll_mode=1`
		;;
	*)
